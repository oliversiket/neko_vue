    ...
    <div v-if="!this.loading" class="hello">
        <form  class="container d-flex flex-column col-lg-4">
            ...
            <div class="buttons d-flex">
                <button type="submit" class="btn btn-info m-3" @click="checkValid">Show me</button>
                <button class="btn btn-info m-3 luckybutton" @click="getLucky" data-toggle="tooltip" data-placement="top" title="Picks a random cat for you">I'm feeling lucky today</button>
            </div>
        </form>

        <Favourites :favs="this.favourites"/>
    </div>

    <div v-else class="spinner d-flex container">
...
export default {
    ...
    methods: {
        ...
        updateBreed(e) {
            ...
            let selectedId = breed === undefined ? '' : breed.id
        ...
        checkValid() {
            if (this.breeds.some(cat => cat.id === this.selectedId)) {
        ...
        getLucky() {
            ...
            this.updateId(random.id)
            this.updateSelected(random.name)
